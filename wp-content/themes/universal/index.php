                    ...
                    <div class="homepage owl-carousel">
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="<?php echo get_template_directory_uri();?>/img/template-homepage.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7 text-center">
                                    <img class="img-responsive" src="<?php echo get_template_directory_uri();?>/img/template-mac.png" alt="">
                                </div>
                        ...
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="<?php echo get_template_directory_uri();?>/img/template-easy-customize.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="<?php echo get_template_directory_uri();?>/img/template-easy-code.png" alt="">
                                </div>
                                <div class="col-sm-5">
                                ...
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="" alt="" src="<?php echo get_template_directory_uri();?>/img/person-1.jpg">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="" alt="" src="<?php echo get_template_directory_uri();?>/img/person-2.jpg">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="" alt="" src="<?php echo get_template_directory_uri();?>/img/person-3.png">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="" alt="" src="<?php echo get_template_directory_uri();?>/img/person-4.jpg">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="<?php echo get_template_directory_uri();?>/img/portfolio-4.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="<?php echo get_template_directory_uri();?>/img/portfolio-3.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="<?php echo get_template_directory_uri();?>/img/portfolio-5.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="<?php echo get_template_directory_uri();?>/img/portfolio-6.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="owl-carousel customers">
                            <li class="item">
                                <img src="<?php echo get_template_directory_uri();?>/img/customer-1.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo get_template_directory_uri();?>/img/customer-2.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo get_template_directory_uri();?>/img/customer-3.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo get_template_directory_uri();?>/img/customer-4.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo get_template_directory_uri();?>/img/customer-5.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo get_template_directory_uri();?>/img/customer-6.png" alt="" class="img-responsive">
                            </li>
                        </ul>
                        <!-- /.owl-carousel -->
                    </div>
